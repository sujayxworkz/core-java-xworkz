...
import com.xworkz.bookmyshow.EntityManagerFactory.EntityManagerFactorySingleton;
import com.xworkz.bookmyshow.Singleton;
...
//        System.out.println(movieTicketDTO);
    ...
    public void deleteMovieInfoById(int id) {
        ...
        if(movieTicketDTO!=null){
            ...
            entityManager.getTransaction().commit();
            System.out.println("movie info successfully de leted");
        }
    ...
    public MovieTicketDTO fetchBookingInfoByTheaterName(String theatreName) {
        EntityManager entityManager = Persistence.createEntityManagerFactory("com_xworkz").createEntityManager();
        Query query = entityManager.createQuery("select dto from MovieTicketDTO as dto where dto.theatre = '"+theatreName+"'");
